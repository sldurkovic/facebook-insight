...
public class HttpManager {
	...
	public String executeGet(String address, List<NameValuePair> params){
		HttpClient httpClient = new DefaultHttpClient();
		URI uri = null;
		try {
//			uri = URIUtils.createURI("http", "localhost", -1, "/Grabber/GrabbingService.svc/GetFacebookData", 
//				    URLEncodedUtils.format(params, "UTF-8"), null);
			uri = new URI(address);
			System.out.println("FBGRABBER URI IS " + uri);
